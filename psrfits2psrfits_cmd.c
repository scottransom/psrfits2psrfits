...
usage(void)
{
  ...
  fprintf(stderr,"%s","      Converts 16-bit PSRFITS search-mode data to 8 or 4-bit PSRFITS\n");
  fprintf(stderr,"%s","         -b: The number of bits in each output sample (4 or 8)\n");
  fprintf(stderr,"%s","             1 int value between 4 and 8\n");
  ...
  fprintf(stderr,"%s","  version: 31May12\n");
  fprintf(stderr,"%s","  ");
  exit(EXIT_FAILURE);
}
/**********************************************************************/
...
parseCmdline(int argc, char **argv)
{
  ...
  for(i=1, cmd.argc=1; i<argc; i++) {
    ...
    if( 0==strcmp("-b", argv[i]) ) {
      ...
      checkIntHigher("-b", &cmd.numbits, cmd.numbitsC, 4);
      continue;
    }
